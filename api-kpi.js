...
// ════════════════════════════════════════════════════════════════════
// Hardcoded KPI Owner backfill — per explicit request ("just make a
// hardcode"), embeds KPI_Owner_01.xlsx's full 180-row dataset directly
// in code rather than requiring a live Excel re-upload each time.
// "Code" (the shorthand A/B/C/D category column) is deliberately left
// blank on every row, per explicit instruction to disregard it — every
// OTHER column (Line, KPI Code, KPI Name, Frequency, KPI Weight %,
// Owner Dept, Owner Name, Owner Email, Owner %) is used. Runs through
// the EXACT SAME grouping (_kpiGroupImportRowsByLineAndCode) and save
// pipeline (importKpiOwnerData) as a live Owner Import upload — no new
// creation logic, just embedded data in the same shape a parsed Excel
// row already produces. One real data-quality fix applied on the way
// in: the source file has "Maintenance" and "Maintenance\xa0" (a
// non-breaking-space variant) as two different-looking department
// names — normalized to plain "Maintenance" here so they don't create
// a duplicate directorate.
app._kpiOwnerHardcodedRows = [
    { line: "L3", code: '', kpiCode: "A1", kpiName: "Passenger satisfaction", periodType: "quarterly", weight: 0.4, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A2", kpiName: "Complaints resolution", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 0.9, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A4", kpiName: "Train environment", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A5", kpiName: "Station environment", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "A6", kpiName: "Ticket office", periodType: "quarterly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B1", kpiName: "Permanent passenger information at Stations", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B2", kpiName: "Permanent passenger information on Trains", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B3", kpiName: "Public announcements", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B4", kpiName: "Information on planned disruption of services", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B5", kpiName: "Incident information at Stations", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "B6", kpiName: "Incident information on Trains", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "C1", kpiName: "Cleanliness of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "C2", kpiName: "Train External Wash", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "C3", kpiName: "Cleanliness of Stations and public facilities", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 0.95, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Contract", ownerPct: 0.05, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Contract", ownerPct: 0.95, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Maintenance", ownerPct: 0.05, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Contract", ownerPct: 0.8, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Maintenance", ownerPct: 0.2, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "D4", kpiName: "Transit System maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E1", kpiName: "Stations and public facilities inspection", periodType: "monthly", weight: 0.4, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E2", kpiName: "Escalators and Elevators availability", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E3", kpiName: "Civil structures inspection", periodType: "yearly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E4", kpiName: "Facilities Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.7, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E5", kpiName: "Facilities corrective maintenance efficiency", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "E6", kpiName: "Facilities maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F1", kpiName: "Injury Frequency Rate (OMC Employee and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F2", kpiName: "Rolling Injury Frequency Rate (OMC Employees and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F3", kpiName: "Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F4", kpiName: "Rolling Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Security", ownerPct: 0.9, ownerName: "HAMAD ALSALMAN", ownerEmail: "Hamad.Alsalman@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "G1", kpiName: "Staffing levels", periodType: "monthly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "G2", kpiName: "Training hours", periodType: "quarterly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "H1", kpiName: "Achieve Annual Performance of Environmental Plan", periodType: "yearly", weight: 1, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 0.8, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Performance", ownerPct: 0.2, ownerName: "ABEER ALAMEEL", ownerEmail: "Abeer.Alameel@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "PSA", kpiName: "Passenger Service Availability", periodType: "monthly", weight: 1, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "TSA", kpiName: "Transit System Availability", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "FOSA", kpiName: "Facilities and Other System Availability", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "TLR", kpiName: "Localisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L3", code: '', kpiCode: "TSR", kpiName: "Saudisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A1", kpiName: "Passenger satisfaction", periodType: "quarterly", weight: 0.4, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A2", kpiName: "Complaints resolution", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 0.9, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A4", kpiName: "Train environment", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A5", kpiName: "Station environment", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "A6", kpiName: "Ticket office", periodType: "quarterly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B1", kpiName: "Permanent passenger information at Stations", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B2", kpiName: "Permanent passenger information on Trains", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B3", kpiName: "Public announcements", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B4", kpiName: "Information on planned disruption of services", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B5", kpiName: "Incident information at Stations", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "B6", kpiName: "Incident information on Trains", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "C1", kpiName: "Cleanliness of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "C2", kpiName: "Train External Wash", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "C3", kpiName: "Cleanliness of Stations and public facilities", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 0.95, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Contract", ownerPct: 0.05, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Contract", ownerPct: 0.95, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Maintenance", ownerPct: 0.05, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Contract", ownerPct: 0.8, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Maintenance", ownerPct: 0.2, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "D4", kpiName: "Transit System maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E1", kpiName: "Stations and public facilities inspection", periodType: "monthly", weight: 0.4, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E2", kpiName: "Escalators and Elevators availability", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E3", kpiName: "Civil structures inspection", periodType: "yearly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E4", kpiName: "Facilities Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.7, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E5", kpiName: "Facilities corrective maintenance efficiency", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "E6", kpiName: "Facilities maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F1", kpiName: "Injury Frequency Rate (OMC Employee and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F2", kpiName: "Rolling Injury Frequency Rate (OMC Employees and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F3", kpiName: "Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F4", kpiName: "Rolling Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Security", ownerPct: 0.9, ownerName: "HAMAD ALSALMAN", ownerEmail: "Hamad.Alsalman@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "G1", kpiName: "Staffing levels", periodType: "monthly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "G2", kpiName: "Training hours", periodType: "quarterly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "H1", kpiName: "Achieve Annual Performance of Environmental Plan", periodType: "yearly", weight: 1, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 0.8, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Performance", ownerPct: 0.2, ownerName: "ABEER ALAMEEL", ownerEmail: "Abeer.Alameel@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "PSA", kpiName: "Passenger Service Availability", periodType: "monthly", weight: 1, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "TSA", kpiName: "Transit System Availability", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "FOSA", kpiName: "Facilities and Other System Availability", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "TLR", kpiName: "Localisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L4", code: '', kpiCode: "TSR", kpiName: "Saudisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A1", kpiName: "Passenger satisfaction", periodType: "quarterly", weight: 0.4, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A2", kpiName: "Complaints resolution", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 0.9, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A4", kpiName: "Train environment", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A5", kpiName: "Station environment", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "A6", kpiName: "Ticket office", periodType: "quarterly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B1", kpiName: "Permanent passenger information at Stations", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B2", kpiName: "Permanent passenger information on Trains", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B3", kpiName: "Public announcements", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B4", kpiName: "Information on planned disruption of services", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B5", kpiName: "Incident information at Stations", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "B6", kpiName: "Incident information on Trains", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "C1", kpiName: "Cleanliness of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "C2", kpiName: "Train External Wash", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "C3", kpiName: "Cleanliness of Stations and public facilities", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 0.95, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Contract", ownerPct: 0.05, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Contract", ownerPct: 0.95, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Maintenance", ownerPct: 0.05, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Contract", ownerPct: 0.8, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Maintenance", ownerPct: 0.2, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "D4", kpiName: "Transit System maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E1", kpiName: "Stations and public facilities inspection", periodType: "monthly", weight: 0.4, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E2", kpiName: "Escalators and Elevators availability", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E3", kpiName: "Civil structures inspection", periodType: "yearly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E4", kpiName: "Facilities Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.7, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E5", kpiName: "Facilities corrective maintenance efficiency", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "E6", kpiName: "Facilities maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F1", kpiName: "Injury Frequency Rate (OMC Employee and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F2", kpiName: "Rolling Injury Frequency Rate (OMC Employees and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F3", kpiName: "Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F4", kpiName: "Rolling Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Security", ownerPct: 0.9, ownerName: "HAMAD ALSALMAN", ownerEmail: "Hamad.Alsalman@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "G1", kpiName: "Staffing levels", periodType: "monthly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "G2", kpiName: "Training hours", periodType: "quarterly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "H1", kpiName: "Achieve Annual Performance of Environmental Plan", periodType: "yearly", weight: 1, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 0.8, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Performance", ownerPct: 0.2, ownerName: "ABEER ALAMEEL", ownerEmail: "Abeer.Alameel@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "PSA", kpiName: "Passenger Service Availability", periodType: "monthly", weight: 1, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "TSA", kpiName: "Transit System Availability", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "FOSA", kpiName: "Facilities and Other System Availability", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "TLR", kpiName: "Localisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L5", code: '', kpiCode: "TSR", kpiName: "Saudisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A1", kpiName: "Passenger satisfaction", periodType: "quarterly", weight: 0.4, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A2", kpiName: "Complaints resolution", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 1, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Public Relations", ownerPct: 0.9, ownerName: "HANI ALHARBI", ownerEmail: "Hani.Alharbi@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A3", kpiName: "Complaints per boarding", periodType: "monthly", weight: 0.2, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A4", kpiName: "Train environment", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A5", kpiName: "Station environment", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "A6", kpiName: "Ticket office", periodType: "quarterly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B1", kpiName: "Permanent passenger information at Stations", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B2", kpiName: "Permanent passenger information on Trains", periodType: "quarterly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B3", kpiName: "Public announcements", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B4", kpiName: "Information on planned disruption of services", periodType: "monthly", weight: 0.3, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B5", kpiName: "Incident information at Stations", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "B6", kpiName: "Incident information on Trains", periodType: "monthly", weight: 0.35, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "C1", kpiName: "Cleanliness of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "C2", kpiName: "Train External Wash", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "C3", kpiName: "Cleanliness of Stations and public facilities", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Operations", ownerPct: 0.95, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D1", kpiName: "Condition of Trains", periodType: "monthly", weight: 0.5, ownerDept: "Contract", ownerPct: 0.05, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Contract", ownerPct: 0.95, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D2", kpiName: "Transit System Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.35, ownerDept: "Maintenance", ownerPct: 0.05, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Contract", ownerPct: 0.8, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D3", kpiName: "Transit System corrective maintenance efficiency", periodType: "monthly", weight: 0.15, ownerDept: "Maintenance", ownerPct: 0.2, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "D4", kpiName: "Transit System maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E1", kpiName: "Stations and public facilities inspection", periodType: "monthly", weight: 0.4, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E2", kpiName: "Escalators and Elevators availability", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E3", kpiName: "Civil structures inspection", periodType: "yearly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E4", kpiName: "Facilities Preventive Maintenance Work Orders completed as scheduled", periodType: "monthly", weight: 0.7, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E5", kpiName: "Facilities corrective maintenance efficiency", periodType: "monthly", weight: 0.3, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "E6", kpiName: "Facilities maintenance quality", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F1", kpiName: "Injury Frequency Rate (OMC Employee and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F2", kpiName: "Rolling Injury Frequency Rate (OMC Employees and Sub-contractors)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F3", kpiName: "Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F4", kpiName: "Rolling Injury Frequency Rate (Public and Passengers)", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Security", ownerPct: 0.9, ownerName: "HAMAD ALSALMAN", ownerEmail: "Hamad.Alsalman@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "F5", kpiName: "Revenue security (fare evasion)", periodType: "quarterly", weight: 0.5, ownerDept: "Finance", ownerPct: 0.1, ownerName: "TARIQ MANSOUR", ownerEmail: "Tariq.Mansour@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "G1", kpiName: "Staffing levels", periodType: "monthly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "G2", kpiName: "Training hours", periodType: "quarterly", weight: 0.5, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "H1", kpiName: "Achieve Annual Performance of Environmental Plan", periodType: "yearly", weight: 1, ownerDept: "Safety", ownerPct: 1, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Safety", ownerPct: 0.8, ownerName: "LUIGI CACCAMO", ownerEmail: "Luigi.Caccamo@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "I1", kpiName: "Reporting", periodType: "monthly", weight: 0.5, ownerDept: "Performance", ownerPct: 0.2, ownerName: "ABEER ALAMEEL", ownerEmail: "Abeer.Alameel@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "PSA", kpiName: "Passenger Service Availability", periodType: "monthly", weight: 1, ownerDept: "Operations", ownerPct: 1, ownerName: "KAMRUL ISLAM", ownerEmail: "Kamrul.Islam@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "TSA", kpiName: "Transit System Availability", periodType: "monthly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "FOSA", kpiName: "Facilities and Other System Availability", periodType: "monthly", weight: 1, ownerDept: "Maintenance", ownerPct: 1, ownerName: "VALERIO COLELLA", ownerEmail: "Valerio.Colella@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "TLR", kpiName: "Localisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Contract", ownerPct: 1, ownerName: "MICHAEL BARRY", ownerEmail: "Michael.Barry@flow-metro.com" },
    { line: "L6", code: '', kpiCode: "TSR", kpiName: "Saudisation Performance Measure", periodType: "quarterly", weight: 1, ownerDept: "Human Resources", ownerPct: 1, ownerName: "IBRAHIM ALTALAL", ownerEmail: "Ibrahim.Altalal@flow-metro.com" },
];

app.importKpiOwnerHardcoded = async function(company) {
    const { groups, conflicts } = this._kpiGroupImportRowsByLineAndCode(this._kpiOwnerHardcodedRows);
    const result = await this.importKpiOwnerData(groups, company || 'OMC');
...
// from AMEEN (1).xlsx's M31_IWF sheet, ALL FOUR line sections (initially
// scoped to just Line 3 per the original request, extended to all lines
// afterward since each line has the identical row structure — frequency
// per KPI genuinely varies by line in the source file, e.g. C1
// "Cleanliness of Trains" is Monthly on L3 but Quarterly on L4/L5/L6,
// preserved exactly as extracted rather than assumed uniform). KPI Month
// 31 maps to May 2026 on the real imported fee calendar (M1 = Nov 2023),
// so each row is saved under whichever real period that KPI's own
// frequency implies for that month: Monthly -> May 2026, Quarterly -> Q2
// 2026 (the quarter May falls in), Annual -> 2026. The two KPIs with no
// data in the sheet for every line (A1, A6 — both always showed "-") are
// correctly left out of every line's list below. Reuses saveKpiResult
// exactly like every other entry path, so Factor Score/Final KPI compute
// identically to a normal manual save.
app.importM31IWFResults = async function(company) {
    ...
    const byLine = {
        ...
        L4: [
            { code: 'A2', periodType: 'monthly', actualValue: 0.9927 },
            { code: 'A3', periodType: 'monthly', actualValue: 16.02 },
            { code: 'A4', periodType: 'monthly', actualValue: 1 },
            { code: 'A5', periodType: 'monthly', actualValue: 1 },
            { code: 'B1', periodType: 'quarterly', actualValue: 1 },
            { code: 'B2', periodType: 'quarterly', actualValue: 1 },
            { code: 'B3', periodType: 'monthly', actualValue: 1 },
            { code: 'B4', periodType: 'monthly', actualValue: 1 },
            { code: 'B5', periodType: 'monthly', actualValue: 1 },
            { code: 'B6', periodType: 'monthly', actualValue: 1 },
            { code: 'C1', periodType: 'quarterly', actualValue: 0.98 },
            { code: 'C2', periodType: 'monthly', actualValue: 0.9963 },
            { code: 'C3', periodType: 'monthly', actualValue: 0.98 },
            { code: 'D1', periodType: 'monthly', actualValue: 1 },
            { code: 'D2', periodType: 'monthly', actualValue: 0.998 },
            { code: 'D3', periodType: 'monthly', actualValue: 1 },
            { code: 'D4', periodType: 'monthly', actualValue: 0.979 },
            { code: 'E1', periodType: 'monthly', actualValue: 1 },
            { code: 'E2', periodType: 'monthly', actualValue: 0.996 },
            { code: 'E3', periodType: 'yearly', actualValue: 1 },
            { code: 'E4', periodType: 'monthly', actualValue: 0.9995 },
            { code: 'E5', periodType: 'monthly', actualValue: 0.9847 },
            { code: 'E6', periodType: 'monthly', actualValue: 1 },
            { code: 'F1', periodType: 'monthly', actualValue: 0.09 },
            { code: 'F2', periodType: 'monthly', actualValue: 0.02 },
            { code: 'F3', periodType: 'monthly', actualValue: 0 },
            { code: 'F4', periodType: 'monthly', actualValue: 0 },
            { code: 'F5', periodType: 'quarterly', actualValue: 0.9867 },
            { code: 'G1', periodType: 'monthly', actualValue: 0.9935 },
            { code: 'G2', periodType: 'quarterly', actualValue: 1 },
            { code: 'H1', periodType: 'yearly', actualValue: 0.9259 },
        ...
        L5: [
            ...
            { code: 'A4', periodType: 'monthly', actualValue: 1 },
            { code: 'A5', periodType: 'monthly', actualValue: 1 },
            { code: 'B1', periodType: 'quarterly', actualValue: 0.9091 },
            { code: 'B2', periodType: 'quarterly', actualValue: 1 },
            { code: 'B3', periodType: 'monthly', actualValue: 1 },
            { code: 'B4', periodType: 'monthly', actualValue: 1 },
            { code: 'B5', periodType: 'monthly', actualValue: 1 },
            { code: 'B6', periodType: 'monthly', actualValue: 1 },
            { code: 'C1', periodType: 'quarterly', actualValue: 0.98 },
            { code: 'C2', periodType: 'monthly', actualValue: 1 },
            { code: 'C3', periodType: 'monthly', actualValue: 0.98 },
            { code: 'D1', periodType: 'monthly', actualValue: 1 },
            { code: 'D2', periodType: 'monthly', actualValue: 1 },
            { code: 'D3', periodType: 'monthly', actualValue: 1 },
            { code: 'D4', periodType: 'monthly', actualValue: 1 },
            { code: 'E1', periodType: 'monthly', actualValue: 1 },
            { code: 'E2', periodType: 'monthly', actualValue: 0.9977 },
            { code: 'E3', periodType: 'yearly', actualValue: 1 },
            { code: 'E4', periodType: 'monthly', actualValue: 0.9983 },
            { code: 'E5', periodType: 'monthly', actualValue: 0.9773 },
            { code: 'E6', periodType: 'monthly', actualValue: 0.9925 },
            { code: 'F1', periodType: 'monthly', actualValue: 0.09 },
            { code: 'F2', periodType: 'monthly', actualValue: 0.02 },
            { code: 'F3', periodType: 'monthly', actualValue: 0 },
            { code: 'F4', periodType: 'monthly', actualValue: 0.05 },
            { code: 'F5', periodType: 'quarterly', actualValue: 0.9867 },
            { code: 'G1', periodType: 'monthly', actualValue: 0.9935 },
            { code: 'G2', periodType: 'quarterly', actualValue: 1 },
            { code: 'H1', periodType: 'yearly', actualValue: 0.9259 },
        ...
        L6: [
            ...
            { code: 'B6', periodType: 'monthly', actualValue: 1 },
            { code: 'C1', periodType: 'quarterly', actualValue: 0.98 },
            { code: 'C2', periodType: 'monthly', actualValue: 0.9965 },
            { code: 'C3', periodType: 'monthly', actualValue: 0.98 },
            { code: 'D1', periodType: 'monthly', actualValue: 1 },
            { code: 'D2', periodType: 'monthly', actualValue: 0.9968 },
            { code: 'D3', periodType: 'monthly', actualValue: 1 },
            { code: 'D4', periodType: 'monthly', actualValue: 1 },
            { code: 'E1', periodType: 'monthly', actualValue: 1 },
            { code: 'E2', periodType: 'monthly', actualValue: 0.996 },
            { code: 'E3', periodType: 'yearly', actualValue: 1 },
            { code: 'E4', periodType: 'monthly', actualValue: 1 },
            { code: 'E5', periodType: 'monthly', actualValue: 0.9822 },
            { code: 'E6', periodType: 'monthly', actualValue: 0.9918 },
            { code: 'F1', periodType: 'monthly', actualValue: 0.09 },
            { code: 'F2', periodType: 'monthly', actualValue: 0.02 },
            { code: 'F3', periodType: 'monthly', actualValue: 0 },
            { code: 'F4', periodType: 'monthly', actualValue: 0 },
    ...
    for (const line of Object.keys(byLine)) {
        for (const row of byLine[line]) {
            const existing = this._kpiFindExistingKpiByCodeAndLine(row.code, line, targetCompany);
            if (!existing) {
                summary.notFound++;
                summary.errors.push(`${line}/${row.code}: no matching KPI found`);
                continue;
            }
            ...
            try {
                ...
                if (!saved) { summary.failed++; summary.errors.push(`${line}/${row.code}: failed to save`); continue; }
                summary.updated++;
            } catch (e) {
                summary.failed++;
                summary.errors.push(`${line}/${row.code}: ${e.message}`);
            }
        }
    }
    this.showToast(`M31_IWF import complete: ${summary.updated} saved, ${summary.notFound} not found, ${summary.failed} failed.`, (summary.notFound + summary.failed) > 0 ? 'error' : 'success');
    return summary;
};
